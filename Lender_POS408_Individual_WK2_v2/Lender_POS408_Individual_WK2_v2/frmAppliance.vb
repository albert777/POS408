Public Class frmAppliance
    ...
    ''All other keystrokes will be ignored
    ''Mead, G. (2009). How to Restrict TextBox Input. Retrieved from http://vbcity.com/blogs/xtab/archive/2009/06/08/restrictiong-textbox-input.aspx
    'Private Sub txtKwh_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtKwh.KeyPress
    '    e.Handled = True
    ...
    ''All other keystrokes will be ignored
    ''Mead, G. (2009). How to Restrict TextBox Input. Retrieved from http://vbcity.com/blogs/xtab/archive/2009/06/08/restrictiong-textbox-input.aspx
    'Private Sub txtHoursUsed_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtHoursUsed.KeyPress
    '    e.Handled = True

    '    If e.KeyChar Like "[.1234567890]" Then _
    '        'Or e.KeyChar = Chr(&H8) Then
    '        'following code instructs the application to not accept the keystroke because it does not match the required input range
    '        e.Handled = False
    ...
    '        'Beep() plays audible error tone to help alert the user that there is an error
    '        Beep()
    '        'Tells the user they are entering invalid keystrokes
    '        MessageBox.Show("Please enter numbers or a '.' only. ")
    ...
    ''All other keystrokes will be ignored
    ''Mead, G. (2009). How to Restrict TextBox Input. Retrieved from http://vbcity.com/blogs/xtab/archive/2009/06/08/restrictiong-textbox-input.aspx
    'Private Sub txtGallonCost_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtGallonCost.KeyPress
    '    e.Handled = True
